      ...
      <div className="container mx-auto px-6 relative">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-4 text-muted-foreground leading-relaxed">
            I craft narrative-led films and brand content. If you're looking for
            an editor or production partner who can translate values into
            emotionally resonant work — let's talk.
          </p>
