...
const featuredProjects = [
  ...
  },
  {
    ...
    impact:
      "Gained wide pickup from sports and lifestyle media and strong social amplification through KOL reposts.",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="space-y-16">
            {featuredProjects.map((project, index) => (
              <Card
                key={index}
                className="fade-in-element overflow-hidden bg-card border-border hover:border-primary/50 transition-all duration-300"
              >
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    <h3 className="text-xl md:text-2xl font-serif font-bold mb-4 text-balance">
                      {project.title}
                    </h3>
